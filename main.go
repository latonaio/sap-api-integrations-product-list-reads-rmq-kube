...
import (
	sap_api_caller "sap-api-integrations-product-list-reads-rmq-kube/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-product-list-reads-rmq-kube/SAP_API_Input_Reader"
	"sap-api-integrations-product-list-reads-rmq-kube/config"
